    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
            ...
            <body>
                ...
                <div class="practice">
                    <form:form action="/search" method="post" modelAttribute="search" class="col-5 my-5 text-dark searchform">
                        <div class="search">
                    ...
                    <table class="table table-bordered border-primary">
                        ...
                        <tbody class="leaderboardTable">
                            <c:forEach var="player" items="${searchLeaderboard.players}">
                                <tr>
                                    <td>
                                        <c:out value="${player.previousUpdateLadderPosition}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${player.summonerName}"></c:out>
                                    </td>
                                    <td><img class="challengerimg" src="https://cdn.lolchess.gg/images/lol/tier/challenger_1.png" alt="Challenger" /></td>
                                    <td>
                                        <c:out value="${player.ratedRating}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${player.wins}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${player.losses}"></c:out>
                                    </td>
                                    <td>
                                        <c:out value="${player.losses}"></c:out>
                                    </td>
